...
import { Compass, LogOut, Plus, User, Vote } from 'lucide-react';
import {
  clearCredentials,
  selectCurrentUser,
  useAppDispatch,
    ...
    <nav className="sticky top-0 z-10 border-b border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/explore"
            className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium text-slate-600 hover:text-cyan-700 dark:text-slate-400 dark:hover:text-cyan-400"
          >
